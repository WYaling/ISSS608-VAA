...
::: callout-note
The selection of the data source is based on the requirements of the take-home exercise of ISSS608 Visual Analytics and Applications, which may introduce limitations to the analysis. However, I strive to utilize data visualization techniques as much as possible in the following analysis.
:::
