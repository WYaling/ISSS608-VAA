...
**How do you feel living in Singapore ?** ![](images/Girl.webp){width="188"}
:::
...
ggsave("images/Stats_temp.png", plot = Stats_temp, width = 8, height = 8, dpi = 300)
```
...
ggsave("images/Stats_rainfall.png", plot = Stats_rainfall, width = 8, height = 8, dpi = 300)
```
