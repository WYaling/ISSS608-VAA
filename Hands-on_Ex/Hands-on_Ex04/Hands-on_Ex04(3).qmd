...
```{r}
#| code-fold: true
#| code-summary: "Show the code: Plotting standard error bars of point estimates"
ggplot(my_sum) +
  geom_errorbar(
    aes(x=RACE, 
        ymin=mean-se, 
...
```{r}
#| code-fold: true
#| code-summary: "Show the code: Plotting confidence interval of point estimates"
ggplot(my_sum) +
  geom_errorbar(
...
```{r}
#| code-fold: true
#| code-summary: "Show the code: Visualizing the uncertainty of point estimates with interactive error bars"
...
# Step 3: Visualising Uncertainty with Hypothetical Outcome Plots (HOPs)
ggplot(data = exam, 
